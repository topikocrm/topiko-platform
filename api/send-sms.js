export default async function handler(req, res) {
    ...
    // Validate inputs - only mobile and message required
    if (!mobile || !message) {
        return res.status(400).json({ error: 'Missing required parameters (mobile, message)' });
    }
    ...
    // Prepare SMS API data for MagicText
