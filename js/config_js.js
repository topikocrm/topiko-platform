...
const INDIAN_PRODUCTS_DB = {
    boutique: {
        ...
        'kids-wear': [
            {id: 'baby-romper-001', name: 'Baby Cotton Romper', image: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=300', description: 'Soft cotton romper for babies', suggestedPrice: 499, category: 'kids-wear', subcategory: 'baby-clothes', variants: ['0-3M', '3-6M', '6-12M', '12-18M'], isSelected: false, isPopular: true},
            {id: 'boys-tshirt-001', name: 'Boys Printed T-Shirt', image: 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=300', description: 'Colorful printed t-shirt for boys', suggestedPrice: 399, category: 'kids-wear', subcategory: 'boys-clothing', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y', '10-11Y'], isSelected: false, isPopular: true},
            {id: 'girls-dress-001', name: 'Girls Party Frock', image: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=300', description: 'Beautiful party dress for girls', suggestedPrice: 899, category: 'kids-wear', subcategory: 'girls-clothing', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y', '10-11Y'], isSelected: false, isPopular: true},
            {id: 'school-uniform-001', name: 'School Uniform Set', image: 'https://images.unsplash.com/photo-1604881988758-f76ad2f7aac1?w=300', description: 'Complete school uniform with shirt and pants/skirt', suggestedPrice: 1299, category: 'kids-wear', subcategory: 'school-uniforms', variants: ['4-5Y', '6-7Y', '8-9Y', '10-11Y', '12-13Y'], isSelected: false, isPopular: true},
            {id: 'kids-party-suit-001', name: 'Kids Party Wear Suit', image: 'https://images.unsplash.com/photo-1503919545889-aef636e10ad4?w=300', description: 'Formal party wear suit for kids', suggestedPrice: 1599, category: 'kids-wear', subcategory: 'party-wear', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y'], isSelected: false, isPopular: false},
            {id: 'kids-kurta-001', name: 'Kids Ethnic Kurta Set', image: 'https://images.unsplash.com/photo-1595786120615-9c3a314ae7fb?w=300', description: 'Traditional kurta pajama for kids', suggestedPrice: 799, category: 'kids-wear', subcategory: 'ethnic-kids', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y', '10-11Y'], isSelected: false, isPopular: true},
            {id: 'kids-pajama-001', name: 'Kids Night Suit', image: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=300', description: 'Comfortable cotton night suit for kids', suggestedPrice: 599, category: 'kids-wear', subcategory: 'kids-nightwear', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y'], isSelected: false, isPopular: true},
            {id: 'kids-swimsuit-001', name: 'Kids Swimming Costume', image: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=300', description: 'UV protection swimming costume', suggestedPrice: 699, category: 'kids-wear', subcategory: 'kids-swimwear', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y'], isSelected: false, isPopular: false},
            {id: 'kids-jacket-001', name: 'Kids Winter Jacket', image: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?w=300', description: 'Warm padded jacket for winter', suggestedPrice: 1299, category: 'kids-wear', subcategory: 'kids-winter-wear', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y', '10-11Y'], isSelected: false, isPopular: true},
            {id: 'baby-onesie-001', name: 'Baby Onesie Set', image: 'https://images.unsplash.com/photo-1522771930-78848d9293e8?w=300', description: 'Pack of 3 cotton onesies', suggestedPrice: 799, category: 'kids-wear', subcategory: 'baby-clothes', variants: ['0-3M', '3-6M', '6-12M'], isSelected: false, isPopular: true},
            {id: 'boys-shorts-001', name: 'Boys Summer Shorts', image: 'https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?w=300', description: 'Comfortable cotton shorts for boys', suggestedPrice: 399, category: 'kids-wear', subcategory: 'boys-clothing', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y'], isSelected: false, isPopular: true},
            {id: 'girls-lehenga-001', name: 'Girls Ethnic Lehenga', image: 'https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?w=300', description: 'Traditional lehenga choli for girls', suggestedPrice: 1499, category: 'kids-wear', subcategory: 'ethnic-kids', variants: ['2-3Y', '4-5Y', '6-7Y', '8-9Y'], isSelected: false, isPopular: false}
        ],
        'designer-collection': [
            {id: 'designer-saree-001', name: 'Designer Kanjivaram Saree', image: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=300', description: 'Pure silk designer saree with zari work', suggestedPrice: 24999, category: 'designer-collection', subcategory: 'designer-sarees', variants: ['One Size'], isSelected: false, isPopular: true},
            {id: 'designer-lehenga-001', name: 'Bridal Designer Lehenga', image: 'https://images.unsplash.com/photo-1583391733975-4770270d3c5e?w=300', description: 'Heavy embroidered bridal lehenga with dupatta', suggestedPrice: 45999, category: 'designer-collection', subcategory: 'designer-lehengas', variants: ['S', 'M', 'L', 'XL'], isSelected: false, isPopular: true},
            {id: 'designer-suit-001', name: 'Designer Anarkali Suit', image: 'https://images.unsplash.com/photo-1583391733975-4770270d3c5e?w=300', description: 'Premium designer anarkali with heavy work', suggestedPrice: 12999, category: 'designer-collection', subcategory: 'designer-suits', variants: ['S', 'M', 'L', 'XL'], isSelected: false, isPopular: true},
            {id: 'bridal-lehenga-001', name: 'Royal Bridal Lehenga', image: 'https://images.unsplash.com/photo-1583391733975-4770270d3c5e?w=300', description: 'Exclusive bridal lehenga with intricate embroidery', suggestedPrice: 89999, category: 'designer-collection', subcategory: 'bridal-wear', variants: ['Custom'], isSelected: false, isPopular: true},
            {id: 'groom-sherwani-001', name: 'Groom Wedding Sherwani', image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=300', description: 'Royal sherwani set with churidar and stole', suggestedPrice: 34999, category: 'designer-collection', subcategory: 'groom-wear', variants: ['S', 'M', 'L', 'XL', 'XXL'], isSelected: false, isPopular: true},
            {id: 'cocktail-dress-001', name: 'Designer Cocktail Dress', image: 'https://images.unsplash.com/photo-1566479179817-c0efeb382d13?w=300', description: 'Elegant cocktail dress for parties', suggestedPrice: 8999, category: 'designer-collection', subcategory: 'cocktail-dresses', variants: ['XS', 'S', 'M', 'L', 'XL'], isSelected: false, isPopular: false},
            {id: 'evening-gown-001', name: 'Luxury Evening Gown', image: 'https://images.unsplash.com/photo-1566479179817-c0efeb382d13?w=300', description: 'Floor-length designer evening gown', suggestedPrice: 15999, category: 'designer-collection', subcategory: 'evening-gowns', variants: ['XS', 'S', 'M', 'L'], isSelected: false, isPopular: true},
            {id: 'luxury-handbag-001', name: 'Designer Leather Handbag', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=300', description: 'Premium Italian leather designer handbag', suggestedPrice: 18999, category: 'designer-collection', subcategory: 'luxury-handbags', variants: ['Brown', 'Black', 'Beige'], isSelected: false, isPopular: true},
            {id: 'premium-watch-001', name: 'Luxury Swiss Watch', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=300', description: 'Premium automatic Swiss movement watch', suggestedPrice: 45999, category: 'designer-collection', subcategory: 'premium-watches', variants: ['Gold', 'Silver', 'Rose Gold'], isSelected: false, isPopular: true},
            {id: 'designer-saree-002', name: 'Designer Georgette Saree', image: 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?w=300', description: 'Embroidered georgette saree with sequins', suggestedPrice: 9999, category: 'designer-collection', subcategory: 'designer-sarees', variants: ['One Size'], isSelected: false, isPopular: false},
            {id: 'groom-suit-001', name: 'Designer Tuxedo Suit', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300', description: 'Premium tuxedo for groom', suggestedPrice: 29999, category: 'designer-collection', subcategory: 'groom-wear', variants: ['S', 'M', 'L', 'XL'], isSelected: false, isPopular: false},
            {id: 'luxury-clutch-001', name: 'Designer Crystal Clutch', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=300', description: 'Crystal embellished evening clutch', suggestedPrice: 7999, category: 'designer-collection', subcategory: 'luxury-handbags', variants: ['Silver', 'Gold', 'Black'], isSelected: false, isPopular: true}
        ]
    },
...
const GOAL_NAMES = {
    ...
    operations: '🕒 Save Time on Business Operations'
};
